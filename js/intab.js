...
var page = {
  ...
  fixedElementCheck:function(){
    ...
    if (document.defaultView.getComputedStyle(document.body)['background-attachment']=='fixed' || document.defaultView.getComputedStyle(document.body)['background-attachment']=='sticky') {
    ...
    while (currentNode = nodeIterator.nextNode()) {
      ...
      exchangeElementStyle(currentNode, ['position'], 'static');
