var api = {
  ...
  listenMessages: function() {
    chrome.runtime.onMessage.addListener(function(data, sender, callback) {
      ...
      if(sender.origin.includes("expertsgroupe.fr")){
  ...
  let zoomNeeded=window.screen.width/1920;
  chrome.tabs.setZoom(zoomNeeded,()=>{chrome.tabs.query({ active: true, currentWindow: true }, function(tabs) {
